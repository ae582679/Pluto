...
void NXUSBDriver::free()
{
	...
	IOSafeDeleteNULL(ivars, NXUSBDriver_IVars, 1);
	super::free();
}

/// - Tag: StartImpl
kern_return_t NXUSBDriver::Start_Impl(IOService* in_provider)
{
	bool success = false;
...
kern_return_t	NXUSBDriver::Stop_Impl(IOService* in_provider)
{
...
kern_return_t NXUSBDriver::NewUserClient_Impl(uint32_t in_type, IOUserClient** out_user_client)
{
...
kern_return_t NXUSBDriver::StartDevice(IOUserAudioObjectID in_object_id, IOUserAudioStartStopFlags in_flags)
{
...
kern_return_t NXUSBDriver::StopDevice(IOUserAudioObjectID in_object_id, IOUserAudioStartStopFlags in_flags)
{
	if (in_object_id != ivars->m_simple_audio_device->GetObjectID())
	{
...
kern_return_t NXUSBDriver::HandleToggleDataSource()
{
...
kern_return_t NXUSBDriver::HandleTestConfigChange()
{
